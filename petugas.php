...
if (isset($_POST['login'])) {
    ...
    if ($username === "petugas" && $password === "1234petugas") {
...
<body>
    <div class="login-card">
        <h4 class="login-title"><i class="fas fa-user-shield me-2"></i>Login Petugas UKS</h4>
...
<div class="container-fluid">
    ...
    <div class="admin-header fade-in">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="header-title"><i class="fas fa-heartbeat me-2"></i>Dashboard Petugas UKS</h2>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.editBtn', function(){
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                return {
                    penanganan: $('#swalPenanganan').val(),
                    kendala: $('#swalKendala').val()
                };
            }
        }).then((result) => {
